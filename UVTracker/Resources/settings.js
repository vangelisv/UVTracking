...
table.addEventListener('click', function(event)
{
	...
	var imgSkinType;
	switch (users[currentUserRow].skin_type) {
...
imgSkinType.addEventListener('click', function() {
	var winSkinDialog = Titanium.UI.createWindow({
	   url:'skin_types.js',
	   backgroundImage:'fitzpatrick_skin_type.jpg'
	});
	winSkinDialog.open({
		modal: true
	});
	var selection = winSkinDialog.selection;
	Ti.API.info('selection '+selection);
	var imgSkinType;
	switch (selection) {
		case 1:  imgSkinType = 'skin_type_I.png'; break; 
		case 2:  imgSkinType = 'skin_type_II.png'; break;
...
var btnSave = Titanium.UI.createButton({
	...
	height:40,
	width:100,
	top:300, // down a bit towards the end of screen
	left:10
});
...
btnSave.addEventListener('click', function() {
	...
	users[currentUserRow].picture = imgPicture.image;
